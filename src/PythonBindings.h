...
///////////////////////////////////////////////////////////////////
    ...
    class_<Parameters>("Parameters", init<>())
            ...
            .def_readwrite("YoungAgeThreshold", &Parameters::YoungAgeThreshold)
            ...
            .def_readwrite("OldAgeThreshold", &Parameters::OldAgeThreshold)
            .def_readwrite("OldAgePenalty", &Parameters::OldAgePenalty)
            .def_readwrite("DetectCompetitiveCoevolutionStagnation", &Parameters::DetectCompetitiveCoevolutionStagnation)
            ...
            .def_readwrite("SimplifyingPhaseMPCThreshold", &Parameters::SimplifyingPhaseMPCThreshold)
            .def_readwrite("SimplifyingPhaseStagnationThreshold", &Parameters::SimplifyingPhaseStagnationThreshold)
            ...
            .def_readwrite("NoveltySearch_No_Archiving_Stagnation_Threshold", &Parameters::NoveltySearch_No_Archiving_Stagnation_Threshold)
            ...
            .def_readwrite("CompatThreshold", &Parameters::CompatThreshold)
            .def_readwrite("MinCompatThreshold", &Parameters::MinCompatThreshold)
            .def_readwrite("CompatThresholdModifier", &Parameters::CompatThresholdModifier)
